...
Deliverable: manifest captures title, theme, and asset index metadata.

2. Substep 1.2: Add project loader for `/project/slides.md` + `/assets`.
...
Deliverable: imported package recreates project in virtual FS.
